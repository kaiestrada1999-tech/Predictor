...
if TURSO_URL and TURSO_TOKEN:
    try:
        ...
        print(f"⚠️ Turso Database connection error: {e}. Falling back to local file storage.")
else:
    print("ℹ️ TURSO_URL or TURSO_TOKEN not provided. Falling back to local file storage.")
